...
namespace LinqConsoleApp
{
    public class LinqSamples
    {
        ...
        */
        ...
        public void Task7()
        {
            var res = Emps.GroupBy(e => e.Job).Select(em => new
            {
                EmployeeJob = em.Key,
                EmployeeNumber = em.Count()
            });
        ...
        public void Task9()
        {
            ...
            //FirstOrDefault() generates TOP(1) SQL.
        }
        ...
        public void Task10()
        {
            // Does Select "No value" , null, null mean select emp where ename ="no value" etc etc?

            //possible solution 1
            var res = (from emp in Emps select new
           {
               emp.Ename,
               emp.Job,
               emp.HireDate
           }).Union(from emp in Emps where emp.Ename=="No value" && emp.Job==null && emp.HireDate == null  select new
           {
               emp.Ename,
               emp.Job,
               emp.HireDate
